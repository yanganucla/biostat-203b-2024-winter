...
labevents_tble <- labevents_subset %>%
  ...
  select(-c(storetime, intime, outtime, label)) %>%
  rename(
    creatinine = '50912',
    potassium = '50971',
    sodium = '50983',
...
```{r}
# Print column names of chartevents_tble
print(colnames(chartevents_tble))

# Print column names of icustays_tble
print(colnames(icustays_tble))

# Print column names of admissions_tble
print(colnames(admissions_tble))

# Print column names of patients_tble
print(colnames(patients_tble))

# Print column names of labevents_tble
print(colnames(labevents_tble))
