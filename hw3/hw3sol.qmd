...
sid_lab <- arrow::write_dataset(labevents <- arrow::open_dataset("~/Desktop/203B/203b-hw/hw3/labevents.csv", format = "csv"), "~/Desktop/203B/203b-hw/hw3/labevents_pq", format = "parquet")
  sib_lab <- arrow::open_dataset("~/Desktop/203B/203b-hw/hw3/labevents_pq", format = "parquet") %>%
...
sid_adt %>%
  ...
  geom_segment(aes(
    ...
    yend = "ADT", 
    color = careunit,
    linewidth = str_detect(careunit, "(ICUICCU)"))
    )+
  labs(title = "Patient 10013310", subtitle = "Top 3 diagnoses: ...", x = "", y = "") +
  theme_minimal()
```
