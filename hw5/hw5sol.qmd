...
- SVM: AUC = 0.56, Accuracy = 0.62
- Random Forest: AUC = 0.57, Accuracy = 0.62
- XGBoost: AUC = 0.52, Accuracy = 0.61
- Stacking: AUC = 0.57, Accuracy = 0.63
Stacking is the best model with 0.57 AUC and 0.63 accuracy, followed by random forest with 0.57 AUC and 0.62 accuracy, and SVM with 0.56 AUC and 0.62 accuracy.
XGBoost has the lowest AUC and accuracy.
...
The stacking model has the best performance and is the most interpretable. The stacking model is the best model for predicting long ICU stays.
