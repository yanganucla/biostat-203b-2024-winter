...
- SVM: AUC = 0.62, Accuracy = 0.57
- Random Forest: AUC = 0.62, Accuracy = 0.57
- XGBoost: AUC = 0.61, Accuracy = 0.52
- Stacking: AUC = 0.57
SVM and Random Foreset model are the best model with 0.62 AUC and 0.57 accuracy. 
The most important features in predicting long ICU stays are the age of the patient, temperature fahrenheit, and heart rate. High heart rate is predictive of long term stay
because it is a sign of stress and the body is working harder to maintain the body temperature.
